# Jaloliddin Manguberdi – 3 Jang Strategiya O‘yini
...
Loyihani GitHub Pages orqali bepul ishlatish mumkin.

1. Repository ga barcha fayllarni yuklash
2. **Settings → Pages** bo‘limiga kirish
3. Source: **main branch**
4. Folder: **/root**
5. **Save**

Shundan keyin loyiha quyidagi link orqali ishlaydi:

```
https://USERNAME.github.io/REPOSITORY_NAME/
```

GitHub Pages hosting **muntazam bepul ishlaydi**.
